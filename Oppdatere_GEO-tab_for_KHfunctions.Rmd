...
kladd <- newtab %>%
    mutate(GEO = as.character(newtab$code))         # Oppretter ny chr-variabel GEO
    
    # For 2022-dataene er det ingen Oslo-koder. 
    # Bør likevel bygges ut med å legge på ledende null hvis 3-5-7-sifret.
    # Kan bruke tallverdiene i code som styring hvis det er enklere.
